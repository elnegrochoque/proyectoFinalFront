...
const EvaluacionNuevaProfesor = () => {
  ...
  const handleShow = () => {
    setShow(true);
    setOpcion1CorrectaPregunta(false);
    setOpcion2CorrectaPregunta(false);
    setOpcion3CorrectaPregunta(false);
    setOpcion4CorrectaPregunta(false);
  };
      ...
      <div className={styles.Container}>
        <div className={styles.container}>
          ...
          <div className={styles.contentcontainer}>
            <Row className="m-5">
              <Col>
                <h3 className=" font-weight-bold">Preguntas</h3>
              </Col>
              <Col>
                ...
                <Form className="container">
                  <FormGroup className="mr-3 ">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => setEnunciadoPregunta(e.target.value)}
                    ></Form.Control>
                  </FormGroup>

                  <h5>Marcar la/s correcta/s </h5>
                  <p>
                    Si no selecciona ninguna sera una pregunta a desarrollar
                  </p>
                  <Row>
                    <FormGroup className="mr-3 col-10">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => setOpcion1pregunta(e.target.value)}
                      ></Form.Control>
                    </FormGroup>
                    <FormGroup
                    ...
                    >
                      <Form.Check
                        ...
                        onClick={(e) => {
                          setOpcion1CorrectaPregunta(e.target.checked);
                        }}
                      />
                    </FormGroup>
                  </Row>
                  ...
                  <Row>
                    <FormGroup className="mr-3 col-10">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => setOpcion2Pregunta(e.target.value)}
                      ></Form.Control>
                    </FormGroup>
                    <FormGroup
                      className="col-1 d-flex  mt-4"
                    ...
                    >
                      <Form.Check
                        ...
                        className=" d-flex align-self-center"
                        onClick={(e) => {
                          setOpcion2CorrectaPregunta(e.target.checked);
                        }}
                      />
                    </FormGroup>
                  </Row>
                  <Row>
                    <FormGroup className="mr-3 col-10">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => setOpcion3Pregunta(e.target.value)}
                      ></Form.Control>
                    </FormGroup>
                    <FormGroup
                      className="col-1 d-flex  mt-4"
                    ...
                    >
                      <Form.Check
                        ...
                        className=" d-flex align-self-center"
                        onClick={(e) => {
                          setOpcion3CorrectaPregunta(e.target.checked);
                        }}
                      />
                    </FormGroup>
                  </Row>
                  <Row>
                    <FormGroup className="mr-3 col-10">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => setOpcion4Pregunta(e.target.value)}
                      ></Form.Control>
                    </FormGroup>
                    <FormGroup
                      className="col-1 d-flex  mt-4"
                    ...
                    >
                      <Form.Check
                        ...
                        className=" d-flex align-self-center"
                        onClick={(e) => {
                          setOpcion4CorrectaPregunta(e.target.checked);
                        }}
                      />
                    </FormGroup>
                  </Row>
